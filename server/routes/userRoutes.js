...
import { applyJob, checkPaymentStatus, getCandidateAppliedJobs, getJobById, getJobPosts, getUser, handlePaymentCallback, initiatePayment, updatePremiumStatus, updateUser } from "../controllers/userController.js";
...
router.post("/update-premium-status/:userId", updatePremiumStatus);
