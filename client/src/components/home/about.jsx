    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <Typography
            variant="h2"
            className="mb-2 text-6xl font-extralight text-transparent bg-clip-text text-deep-orange-400"
          >
            About Us
          </Typography>
          <motion.div
          ...
          >
            <Typography className="text-lg lg:text-xl mb-14  max-w-4xl mx-auto">
              At our restaurant manpower hiring portal, we're more than a bridge
              between candidates and restaurants – we're the architects of
              culinary success stories. With a fervor for flavors and a
              commitment to excellence, we curate connections that transform
              careers and elevate dining experiences.
            </Typography>
          </motion.div>
        </div>
      ...
      <Card className="h-full bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 shadow-lg backdrop-blur-sm bg-opacity-90 overflow-hidden">
        ...
        <CardBody>
          <Typography
            variant="h5"
            color="white"
            className="mb-2 font-bold text-transparent bg-clip-text text-deep-orange-400"
          >
            {title}
          </Typography>
